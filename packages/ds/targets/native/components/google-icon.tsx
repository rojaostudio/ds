...
// Marca multicolor do Google ("G"). NÃO herda a cor do label do botão —
// ignora qualquer `color` injetada pelo tint do Button, preservando as 4 cores.
// Aceita `size` (o Button passa 18 por padrão).
